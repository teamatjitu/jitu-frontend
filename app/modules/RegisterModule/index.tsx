...
export const RegisterModule = () => {
  ...
  return (
    <main className="flex p-4 md:p-6 relative gap-8 bg-blue-500 max-lg:justify-center justify-between max-lg:items-center min-h-screen">
      <div className="font-semibold flex mt-32 ml-12 text-white max-lg:hidden flex-col">
        <h1 className="text-4xl">Mulai Bersama JituPTN</h1>
        <p className="text-2xl">
          Platform yang membantu mempersiapkan diri dan sukses di ujian masuk
          PTN
        </p>
      </div>
      <img
