...
const weekDays = ["Kam", "Jum", "Sab", "Min", "Sen", "Sel", "Rab"];
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="ml-20 mt-24 p-8">
          ...
          {menuItems.map((menu, index) => (
            ...
            >
              ...
              {index === menuItems.length - 1 && (
                <button className="w-full mt-3 text-emerald-600 font-semibold text-sm hover:text-emerald-700 flex items-center justify-center gap-1 p-3 hover:bg-emerald-50 rounded-xl transition-all">
                  Pengaturan lengkap
                  <ChevronRight className="w-4 h-4" />
                </button>
              )}
        ...
        <div className="mt-8 flex justify-center">
          <button className="bg-white border-2 border-red-200 text-red-600 px-8 py-3 rounded-xl font-bold hover:bg-red-50 hover:border-red-300 transition-all flex items-center gap-2 shadow-sm">
