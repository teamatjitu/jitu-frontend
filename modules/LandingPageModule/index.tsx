      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#gamification" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">Gamifikasi</a>
            <a href="#preview" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">Tryout</a>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <Image src="/logo.png" alt="JituPTN Logo" width={32} height={32} className="opacity-90 grayscale brightness-200" />
            <span className="text-xl font-bold">JituPTN</span>
          </div>
          <p className="text-gray-400 text-sm">
            Platform simulasi Tryout UTBK SNBT terbaik dengan sistem penilaian IRT dan analisis mendalam.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400 text-sm">
            <li><a href="#" className="hover:text-white">Tryout SNBT</a></li>
            <li><a href="#" className="hover:text-white">Analisis Peluang</a></li>
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            <div className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white cursor-pointer transition-all">IG</div>
            <div className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white cursor-pointer transition-all">TW</div>
          </div>
        </div>
      </div>
...
const LandingPageModule = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 1. HERO SECTION */}
      <section className="pt-32 pb-20 px-4 bg-[url('/grid-pattern.svg')] bg-fixed bg-center">
        <div className="max-w-7xl mx-auto text-center space-y-8">
          <Badge className="px-4 py-2 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-full text-sm font-medium border border-blue-200">
            🚀 Platform #1 Persiapan UTBK 2026
          </Badge>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Simulasi ujian dengan sistem penilaian IRT, analisis peluang lolos real-time, 
            dan gamifikasi yang membuat belajar jadi ketagihan.
          </p>
          ...
          {/* Social Proof Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 max-w-4xl mx-auto border-t border-gray-100 mt-12">
            {[
      ...
      <section id="features" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Kenapa Memilih Jitu Academy?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Kami tidak hanya memberikan soal, tapi juga strategi dan teknologi untuk memaksimalkan skormu.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              <Badge className="bg-orange-100 text-orange-700 hover:bg-orange-200 px-4 py-1">
                🔥 Belajar Jadi Seru
              </Badge>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Bosan dengan cara belajar lama? Di Jitu Academy, konsistensimu dihargai.
                Kerjakan soal harian, pertahankan api streak, dan kumpulkan token untuk membuka kunci pembahasan premium.
              </p>
              ...
              <div className="relative z-10 grid gap-6">
                ...
                <Card className="bg-white shadow-2xl border-orange-100 transform md:-rotate-2 hover:rotate-0 transition-transform duration-500">
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-semibold">Current Streak</p>
                      <h4 className="text-3xl font-bold text-gray-900">7 Hari 🔥</h4>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white shadow-2xl border-blue-100 transform md:translate-x-12 md:rotate-2 hover:rotate-0 transition-transform duration-500">
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-semibold">Token Balance</p>
                      <h4 className="text-3xl font-bold text-gray-900">250 JituPoints</h4>
                    </div>
                  </CardContent>
                </Card>
              </div>
      ...
      <section id="preview" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Jadwal Tryout Terdekat</h2>
              <p className="text-gray-600">Siapkan dirimu, kursi terbatas untuk sesi live.</p>
            </div>
            <Button variant="ghost" className="text-blue-600 hover:bg-blue-50" onClick={() => router.push('/login')}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {activeTryOuts.map((tryOut) => (
              <Card key={tryOut.id} className="group hover:shadow-lg transition-all duration-300 border-gray-200">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <Badge className={`${tryOut.isFree ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'} hover:bg-opacity-80`}>
                  ...
                  <Button className="w-full bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-blue-200 hover:text-blue-600 font-semibold" onClick={() => router.push('/login')}>
                    Ikuti Tryout
                  </Button>
                </CardContent>
              </Card>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-blue-600 rounded-3xl p-12 text-center text-white relative overflow-hidden">
          <div className="relative z-10 space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">Siap Mengejar Kampus Impian?</h2>
            <p className="text-blue-100 max-w-xl mx-auto text-lg">
              Bergabunglah dengan ribuan pejuang PTN lainnya. Mulai dari gratis, upgrade kapan saja.
            </p>
            <Button 
              onClick={() => router.push("/register")}
